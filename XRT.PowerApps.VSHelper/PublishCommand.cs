...
{
    /// <summary>
    /// Publishes a file to the configured PowerApps environment.
    /// </summary>
    internal sealed class PublishCommand
    {
        ...
        private PublishCommand(AsyncPackage package, OleMenuCommandService commandService)
        {
            ...
            var menuCommandID = new CommandID(Refs.CommandSet, Refs.PublishCommandId);
        ...
        private async Task ExecuteAsync(object sender, EventArgs e)
        {
            ...
            await commandController.ExecutePublishCommandAsync();
        }
